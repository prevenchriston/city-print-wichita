...
**Project:** City Print Wichita
**Generated:** 2026-09-18 20:38:35
**Category:** E-commerce Luxury
**Design Dials:** Variance 5/10 (Balanced / Modern) | Motion 6/10 (Standard) | Density 4/10 (Standard)
...
## Project overrides (applied in the built site)

The generator's default output (Liquid Glass style, dark + gold, Playfair/Inter) does not suit a print shop, so the build departs from it:

- **Style:** Paper & ink editorial. Warm paper `#F5F1E8`, ink `#15120F`. CMYK is the accent language (`#0AA5DF` cyan, `#E3117B` magenta, `#FFD500` yellow, `#231F20` key), taken from the City Print swirl logo.
- **Type:** Fraunces (display) + Inter (body).
- **Motion:** vanilla CSS + IntersectionObserver, `transform`/`opacity` only, no animation library, full `prefers-reduced-motion` fallback.
- **Motifs:** crop marks, registration mark, halftone dots, 4-plate scroll-progress bar, black-plate to full-color slider.
